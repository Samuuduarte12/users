...
const { createUsuario, listarUsuarios, eliminarUsuarios, editarUsuario} = require("../controllers/userController"); // Importa los controladores que manejan la lógica de cada ruta
...
router.delete("/users/:id", eliminarUsuarios);
